...
## Overview
The purpose of a class implementing IFormEventHandler, is to patronize the customizations and programmatically customize your dictionary rules without a custom view.

To customize your business rules you can use one of these:

## C# interface implementations
A .NET Form Event is a class that implements the IFormEventHandler interface.

Implement IFormEventHandler in your class and then generate your overrides with CTRL+. in your class using VS or Rider:
...
IFormEventHandlerResolver is the responsible for retrieving IFormEventHandler implementations from an element name.
