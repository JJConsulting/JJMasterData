...
//
// [Trait("Category", "JJMasterData.Commons")]
// public class SintegraWsTest
// {
//     private readonly IReceitaFederal _sintegra;
//
//     public SintegraWsTest(SintegraService sintegraService)
//     {
//         _sintegra = sintegraService;
//     }
//
//     [Theory]
...
//     {
//         var obj = _sintegra.SearchCnpj(cnpj);
...
//     {
//         DateTime.TryParse(birth, out var birthDate);
//
//         var cpfInfo = _sintegra.SearchCpf(cpf, birthDate);
//         Assert.Equal("NOK", cpfInfo.Return);
//     }
//
//     [Theory]
//     [InlineData("", "")]
...
//         DateTime.TryParse(birth, out var birthDate);
//
//         var obj = _sintegra.SearchCpf(cpf, birthDate);
//         Assert.Equal("ERROR", obj.Return);
//     }
//
//     [Theory]
...
//     {
//         var obj = _sintegra.SearchCep(cep);
//         Assert.Equal("ERROR", obj.Return);
//     }
//
//     [Theory]
