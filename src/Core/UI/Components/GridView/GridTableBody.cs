...
internal class GridTableBody
{
    ...
    private async IAsyncEnumerable<HtmlBuilder> GetRowsList()
    {
        ...
        {
            yield return await GetRowHtml(data[i], i);
        }
    }

    internal async Task<HtmlBuilder> GetRowHtml(IDictionary<string,dynamic> row, int index)
    {
    ...
    internal async IAsyncEnumerable<HtmlBuilder> GetTdHtmlList(IDictionary<string,dynamic> row, int index)
    {
    ...
    private async IAsyncEnumerable<HtmlBuilder> GetVisibleFieldsHtmlList(IDictionary<string,dynamic> row, int index, IDictionary<string, dynamic> values, string onClickScript)
    {
    ...
    private async Task<HtmlBuilder> GetEditModeFieldHtml(FormElementField field, IDictionary<string,dynamic> row, int index, IDictionary<string, dynamic> values,
        string value)
    {
    ...
    private JJCheckBox GetMultiSelect(IDictionary<string,dynamic> row, int index, IDictionary<string, dynamic> values)
    {
    ...
    private async Task<IDictionary<string, dynamic>> GetValues(IDictionary<string,dynamic> row)
    {
