...
public class FormElementDataItem
{
    ...
    /// <remarks>
    /// Be careful when using this option, you will maybe use this option to WriteOnly fields or store the values in another table.
    /// </remarks>
    [DataMember(Name = "enableMultipleValues")]
