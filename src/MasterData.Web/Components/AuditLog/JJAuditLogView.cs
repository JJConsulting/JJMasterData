...
public class JJAuditLogView : AsyncComponent
{
    ...
    private AuditLogFormElementFactory AuditLogFormElementFactory { get; }
    ...
    private JJGridView CreateGridViewLog()
    {
        ...
        var gridViewFormElement = AuditLogFormElementFactory.Create(FormElement);
