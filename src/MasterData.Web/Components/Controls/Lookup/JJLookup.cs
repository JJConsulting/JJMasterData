...
public class JJLookup : ControlBase
{
    ...
    private LookupRequestService LookupRequestService { get; }
    ...
    public object? SelectedValue
    {
        get
        {
            ...
            {
                _selectedValue = LookupRequestService.GetSelectedValue(Name);
            }
    ...
    {
        var selectedValue = LookupRequestService.GetSelectedValue(Name);
    ...
    protected internal override async ValueTask<HtmlBuilder> GetHtmlBuilderAsync()
    {
        ...
        var formViewUrl = LookupRequestService.GetFormViewUrl(ElementMap, FormStateData, Name);
